...
\begin{enumerate}
    ...
    \item Diseñar e implementar un algoritmo de control de posición basado en retroalimentación del sensor ultrasónico que permita posicionar el montacargas en cuatro plantas predefinidas con precisión de $\pm$2 cm.
